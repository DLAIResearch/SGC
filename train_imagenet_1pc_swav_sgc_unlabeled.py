...
import models.swav_resnet_sgc as resnet
from datasets.imagefolder_sgc_ssl import ImageFolder
import logging
...
parser.add_argument('--resume', default='swav_800ep_pretrain.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
                    help='evaluate model on validation set')
parser.add_argument('--pretrained', dest='pretrained', default='Ture',action='store_true',
...
def main_worker(gpu, ngpus_per_node, args, logger):
    ...
    if args.arch.startswith('resnet'):
        ...
        model = resnet.__dict__[args.arch](output_dim=100)
    else:
    ...
    unlabeled_dataset=ImageFolder(unlabeleddir)
...
def save_checkpoint(state, is_best, save_dir):
    ...
    if is_best:
        best_filename = 'model_best.pth-imageulib_0.01-0.5.tar'
