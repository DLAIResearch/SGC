...
import models.resnet_multigpu_sgc as resnet
...
def main_worker(gpu, ngpus_per_node, args, logger):
    ...
    #         model.load_state_dict(torch.load("./premodel/resnet18-5c106cde.pth"))
    #     elif args.arch == 'resnet50':
    #         logger.info("=> using pre-trained model 'resnet50'")
    #         model = resnet.resnet50(pretrained=False)
    #         model.load_state_dict(torch.load("./premodel/resnet50-19c8e357.pth"))
    #     else:
...
def train(train_loader, model, contrastive_criterion, xent_criterion, optimizer, epoch, args, logger):
    ...
    for i in range(train_len):
        xe_images , images, aug_images, pred, targets = train_iter.__next__()
